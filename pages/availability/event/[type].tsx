    ...
    async function updateEventTypeHandler(event) {
        ...
        const response = await fetch('/api/availability/eventtype', {
            ...
            body: JSON.stringify({
                ...
                maxAttendees: enteredMaxAttendees,
    ...
    const LocationOptions = () => {
        ...
        switch (selectedLocation.value) {
            case LocationType.InPerson:
                ...
                return (
                    <div>
                        <label htmlFor="address" className="block text-sm font-medium text-gray-700">Set an address or
                            place</label>
                        <div className="mt-1">
                                ...
                                <form onSubmit={updateEventTypeHandler}>
                                    <div className="mb-4">
                                        ...
                                        <div className="mt-1">
                                            <input ref={titleRef} type="text" name="title" id="title" required
                                                   className="shadow-sm focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md"
                                                   placeholder="Quick Chat" defaultValue={props.eventType.title}/>
                                        </div>
                                    </div>
                                    <div className="mb-4">
                                        <label htmlFor="slug"
                                                    ...
                                                    <div className="flex justify-between">
                                                        ...
                                                        <div className="flex">
                                                            ...
                                                            <button onClick={() => removeLocation(location)}>
                                                                <XIcon
                                                                    className="h-6 w-6 border-l-2 pl-1 hover:text-red-500 "/>
                                                            </button>
                                                        </div>
                                                    </div>
                                                </li>
                                    ...
                                    <div className="mb-4">
                                        ...
                                        <div className="mt-1 relative rounded-md shadow-sm">
                                            <input ref={lengthRef} type="number" name="length" id="length" required
                                                   className="focus:ring-blue-500 focus:border-blue-500 block w-full pr-20 sm:text-sm border-gray-300 rounded-md"
                                                   placeholder="15" defaultValue={props.eventType.length}/>
                                            <div
                                                className="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 text-sm">
                                                minutes
                                            </div>
                                        </div>
                                    </div>
                                    <div className="mb-4">
                                        <label htmlFor="maxAttendees"
                                               className="block text-sm font-medium text-gray-700">Max Attendees</label>
                                        <div className="mt-1 relative rounded-md shadow-sm">
                                            <input ref={maxAttendeesRef} type="number" name="maxAttendees" id="maxAttendees" required
                                                   className="focus:ring-blue-500 focus:border-blue-500 block w-full pr-20 sm:text-sm border-gray-300 rounded-md"
                                                   placeholder="15" defaultValue={props.eventType.maxAttendees}/>
                                        </div>
                                    </div>
                                    ...
                                    <div className="my-8">
                                        <div className="relative flex items-start">
                                            ...
                                            <div className="ml-3 text-sm">
                                                <label htmlFor="weekday-1" className="font-medium text-gray-700">
                                                    Monday
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div className="my-8">
                                        <div className="relative flex items-start">
                                            ...
                                            <div className="ml-3 text-sm">
                                                <label htmlFor="weekday-2" className="font-medium text-gray-700">
                                                    Tuesday
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div className="my-8">
                                        <div className="relative flex items-start">
                                            ...
                                            <div className="ml-3 text-sm">
                                                <label htmlFor="weekday-3" className="font-medium text-gray-700">
                                                    Wednesday
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div className="my-8">
                                        <div className="relative flex items-start">
                                            ...
                                            <div className="ml-3 text-sm">
                                                <label htmlFor="weekday-4" className="font-medium text-gray-700">
                                                    Thursday
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div className="my-8">
                                        <div className="relative flex items-start">
                                            ...
                                            <div className="ml-3 text-sm">
                                                <label htmlFor="weekday-5" className="font-medium text-gray-700">
                                                    Friday
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div className="my-8">
                                        <div className="relative flex items-start">
                                            ...
                                            <div className="ml-3 text-sm">
                                                <label htmlFor="weekday-6" className="font-medium text-gray-700">
                                                    Saturday
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div className="my-8">
                                        <div className="relative flex items-start">
                                            ...
                                            <div className="ml-3 text-sm">
                                                <label htmlFor="weekday-0" className="font-medium text-gray-700">
                                                    Sunday
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div className="my-8">
                                        <div className="relative flex items-start">
                                            ...
                                            <div className="ml-3 text-sm">
                                                ...
                                                <p className="text-gray-500">Hide the event type from your page, so it
                                                    can only be booked through it's URL.</p>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div className="col-span-3 sm:col-span-1">
                        <div className="bg-white shadow sm:rounded-lg">
                            <div className="px-4 py-5 sm:p-6">
                                ...
                                <div>
                                    <button onClick={deleteEventTypeHandler} type="button"
                        ...
                        <div
                            ...
                            <div className="sm:flex sm:items-start mb-4">
                                ...
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                    <h3 className="text-lg leading-6 font-medium text-gray-900" id="modal-title">Edit
                                        location</h3>
                                </div>
                            </div>
